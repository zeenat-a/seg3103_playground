...
class DateTest {
  ...
  @Test
  void setDay_invalid_negative() {
      assertThrows(IllegalArgumentException.class, () -> new Date(2024, 6, -5));
  }
  
  //Additional Tests

  @Test
  void setDay_invalid_greaterThan31() {
      assertThrows(IllegalArgumentException.class, () -> new Date(2024, 6, 35));
  }
  
  @Test
  void setDay_invalid_thirtyDayMonth() {
      assertThrows(IllegalArgumentException.class, () -> new Date(2024, 4, 31)); // April has 30 days
  }
  
  @Test
  void setDay_invalid_leapYearFebruary() {
      assertThrows(IllegalArgumentException.class, () -> new Date(2024, 2, 30)); // 2024 is a leap year
  }
  
  @Test
  void setDay_invalid_nonLeapYearFebruary() {
      assertThrows(IllegalArgumentException.class, () -> new Date(2023, 2, 29)); // 2023 is not a leap year
  }
